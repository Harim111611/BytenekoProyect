...
urlpatterns = [
    ...
    path('import/new/', import_views.import_new_view, name='import_new'),
    ...
    path('import/async/start/', import_views.csv_create_start_import, name='import_async'),
    ...
    path("<str:public_id>/api/save-segment/", report_views.save_analysis_segment_view, name="save_segment"),
