...
urlpatterns = [
    ...
    path("dashboard/", core_views.dashboard_view_sync, name="dashboard"),
    # Aceptar también sin slash para evitar redirects en entornos de test
    path("dashboard", core_views.dashboard_view_sync),
    path("results/", core_views.dashboard_results_view_sync, name="dashboard_results"),
    path("results", core_views.dashboard_results_view_sync),
